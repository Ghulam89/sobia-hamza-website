  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        axios
          .post(`getSingleStore/${res.data?.createdBy?.store}`)
          .then((res) => {
            console.log(res);
    ...
    <div>
      ...
      <div className=" md:flex block container md:px-10 px-0 mx-auto py-4 justify-between">
          ...
          <li>
              ...
              <li>
                <a className=" text-gray-500  font-medium text-sm ">
                 Bonds Baby value Zip Wondersuit - Blue
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className=" md:w-[45%] w-[100%] p-4">
         ...
         <p className=" pb-2 text-xl">{`${allProduct?.title}`}</p>
         <div className=" pt-3">
          <ul className=" flex gap-2 pb-2 items-center">
            <li>
            <FaStar />
