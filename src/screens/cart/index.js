    ...
    <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
        ...
        <div class="space-y-6">
          {productData?.map((item,index)=>{
            ...
            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
              <a href="#" class="shrink-0 md:order-1 border p-2 rounded-md shadow-md">
      ...
      <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
        <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
          ...
          <div class="space-y-8">
            <div class="space-y-6">
              <dl class="flex items-center justify-between gap-4">
                ...
                <dd class="text-base font-medium text-gray-900 dark:text-white">${totalPriceAfterDiscount}</dd>
              </dl>
          ...
          <a href="#" class="flex w-full items-center justify-center rounded-lg bg-[#232323] px-5 py-2.5 text-sm font-medium text-white hover:bg-[#232323] focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Proceed to Checkout</a>
